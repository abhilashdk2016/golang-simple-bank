...
// Source: github.com/abhilashdk2016/golang-simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddUpdateAccount(arg0 context.Context, arg1 db.AddUpdateAccountParams) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetAccountForUpdates(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
